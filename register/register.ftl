   ...
   <div class="kcform">
        ...
        <form action="${url.registrationAction}" method="post">
            ...
            <div class="form-group">
               <div class="${properties.kcLabelWrapperClass!}">
                   <label for="user.attributes.type" class="${properties.kcLabelClass!}">User Type</label>
               </div>

               <div class="${properties.kcInputWrapperClass!}">
                   <input type="text" class="${properties.kcInputClass!}" id="user.attributes.type" name="user.attributes.type" value="${(register.formData['user.attributes.type']!'')}"/>
               </div>
            </div>
